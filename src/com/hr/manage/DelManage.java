...
public class DelManage extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if(num>0){
			...
			//response.getWriter().print("<script>alert('successfully deleted!');history.back();<script>");
		}else{
			response.getWriter().print("<script>alert('failed to delete!');location.href='SelManage'<script>");
		}
	}
}
