...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="newsselect">News</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
		...
		<div class="manage">
			<table class="list">
				...
				<tr>
					...
					<td>${n.EN_TITLE }</td>
					<td class="w1 c"><a href="upnews?id=${n.EN_ID }">Edit</a> <a href="javascript:Delete2(${n.EN_ID });">Delete</a></td>
				</tr>
				</c:forEach>
			</table>
			current:${cpage }/${tpage }page
			<a href="newsselect?cp=1">Mainpage</a>
			<a href="newsselect?cp=${cpage-1<=0 ?1:cpage-1}">Previous</a>
			<a href="newsselect?cp=${cpage+1>=tpage ? tpage : cpage+1 }">Next page</a>
			<a href="newsselect?cp=${tpage }">Last page</a>
